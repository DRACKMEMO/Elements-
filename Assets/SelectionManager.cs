...
public class SelectionManager : MonoBehaviour
{
    ...
    private int player1SelectedIndex = -1; // Track Player 1's selected character index
    private int player2SelectedIndex = -1; // Track Player 2's selected character index
